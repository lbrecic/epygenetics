...
methylCIPHER_type_4 = pd.DataFrame({
...
methylCIPHER_type_5 = pd.DataFrame({
...
methylCIPHER_type_6 = pd.DataFrame({
...
epygenetics_type_4 = pd.DataFrame({
...
epygenetics_type_5 = pd.DataFrame({
