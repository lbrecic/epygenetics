...
from epygenetics.clocks.cancer_and_mitotic_rates_predictors.hypo_clock import HypoClock
from epygenetics.clocks.type import ClockType


class HypoClockTestCase(unittest.TestCase):

    @patch('pandas.read_csv')
    def test_initialization(self, mock_read_csv):
        """Test the initialization of HypoClock."""
        # Mock the CpG DataFrame
        mock_cpgs = pd.DataFrame({
            'hypoClock_CpGs': ['cg00000029', 'cg00000108', 'cg00000109']
        })
        ...
        self.assertEqual(clock.marker_name, 'hypoClock_CpGs')
