...
from epygenetics.clocks.gestational_and_pediatric_age_predictors.bohlin import BohlinClock
from epygenetics.clocks.type import ClockType


class BohlinClockTestCase(unittest.TestCase):

    @patch('pandas.read_csv')
    def test_initialization(self, mock_read_csv):
        """Test the initialization of BohlinClock."""
        ...
        self.assertEqual(clock.reg_coef, 277.2421)
