...
from epygenetics.clocks.biological_age_and_mortality_predictors.non_prc_pheno_age import NonPRCPhenoAgeClock
...
class NonPRCPhenoAgeClockTestCase(unittest.TestCase):
    ...
    def test_initialization(self, mock_read_csv):
        ...
        mock_read_csv.assert_called_once_with('data/CpGs/non_prcPhenoAge_CpGs.csv')
