...
from epygenetics.clocks.biological_age_and_mortality_predictors.hrs_in_ch_pheno_age import HRSInCHPhenoAgeClock
from epygenetics.clocks.type import ClockType


class HRSInCHPhenoAgeClockTestCase(unittest.TestCase):

    @patch('pandas.read_csv')
    def test_initialization(self, mock_read_csv):
        """Test the initialization of HRSInCHPhenoAgeClock."""
        ...
        self.assertEqual(clock.reg_coef, 52.8334080)
